...
import { uploadImage, deleteImage } from "@/utils/supabase/supabase"
...
export function ImageManagerDialog({ open, onOpenChange, vehicle, onSave }: ImageManagerDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Añade, elimina o reordena las imágenes del vehículo {vehicle.brand} {vehicle.model}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2">
                <Input
                  ...
                  className="max-w-sm"
                  value="" // Añadir un valor vacío para asegurar que siempre sea controlado
                />
          ...
          {isUploading && (
            <div className="w-full bg-secondary rounded-full h-2.5">
              ...
              <p className="text-sm text-muted-foreground mt-1">Subiendo imágenes: {uploadProgress}%</p>
            </div>
          )}
          ...
          {images.length === 0 ? (
            <div className="text-center py-8 border-2 border-dashed rounded-lg">
              ...
              <p className="mt-1 text-sm text-muted-foreground">Sube imágenes para mostrar este vehículo</p>
            </div>
          ) : (
              ...
              {images.map((imageUrl, index) => (
                ...
                >
                  <Image
                    ...
                    alt={`Imagen ${index + 1} de ${vehicle.brand} ${vehicle.model}`}
                    fill
